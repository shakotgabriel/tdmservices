...
const ContactForm = () => {
  ...
  return (
    <section className="bg-black dark:bg-gray-900 rounded-lg p-4 w-full max-w-4xl mx-auto mb-8 flex">
      <div className="w-full h-full overflow-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="bg-gradient-to-r from-red-200 to-amber-200  text-white font-bold py-2 px-4 border-b-4   rounded w-full"
          >
            Send message
          </button>
        </form>
      ...
      <div className="w-1/2 pl-4">
        ...
        <div className="h-64 bg-gray-300 rounded-lg">
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.835434509123!2d31.6015623153163!3d4.85100097975157!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x17e1b1c1c1c1c1c1%3A0x5045675218ceed30!2sMay%20Street%2C%20Juba%2C%20South%20Sudan!5e0!3m2!1sen!2sau!4v1616161616161!5m2!1sen!2sau"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
        ...
        {/* Working Hours */}
        <h3 className="text-lg font-bold mt-4">Working Hours</h3>
